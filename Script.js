...
<div class="ui inverted segment">
  <div class="ui inverted form">
	...
	<div class="field" id="botname">
        ...
        <div class="ui large labeled input"><input type="text" value="${params.get('name') || "ezekiel"}" placeholder="Nickname" maxlength="17" spellcheck="false" data-ms-editor="true"></div>
      </div>
      <div class="field">
...
<div class="ui fluid selection profil bot-image dropdown" tabindex="0">
  ...
  <div class="inline fields">
    ...
    <a href="https://github.com/ezekiel/gartic.io-bot" target="_blank" class="ui right floated
...
<a href="https://ezekiel.github.io/gartic.io-bot/" class="ui right floated
...
<div class="field"><div class="ui labeled input" id="messagetext"><input type="text" value="${params.get('message-text') || "ezekiel"}" placeholder="Message text" maxlength="1000" spellcheck="false" data-ms-editor="true"></div></div><div class="field">
...
let imageUrl = `https://raw.githubusercontent.com/ezekiel/gartic.io-bot/main/docs/v2/draw.png`;
...
btn.addEventListener("click", async function () {
  ...
  for (let i = 0; i < params.get('amount'); i++) {
    ...
    if (params.get('private-mode') === "true") {
      ...
      if (regex.test(name)) {
        document.querySelector('#botname div input').value = "ezekiel";
        name = "ezekiel";
      }
    ...
    socket.addEventListener('message', (event) => {
      ...
      switch (data[0]) {
        case 5: {
          ...
          if (params.get('private-mode') !== "true") { socket.send(`42[11,"${playerId}","sa"]`); }
        ...
        case 23: {
          ...
          if (!existingItem) {
            ...
            if (data[1].nick.startsWith("ewqewqewqewewqewq") && data[1].avatar === 1) {
...
document.querySelector("#send").addEventListener("click", function () {
  ...
  if (regex.test(messagetext)) {
    document.querySelector('#messagetext input').value = "ezekiel";
    messagetext = "ezekiel";
  }
    ...
    socketList.forEach((socket) => {
      if (socket.readyState === WebSocket.OPEN) {
        ...
        if (regex.test(spamtext)) {
          document.querySelector('#spamtext input').value = "ezekiel";
          spamtext = "ezekiel";
        }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("saveImageButton").addEventListener("click", async function () {
    if (currentTagTarget.tagName === 'IMG') {
      try {
        var filename = currentTagTarget.getAttribute('data-name') + '-ezekiel.jpg';
